...
const LABELS: Record<string, Partial<Record<Locale, string>>> = {
  ...
  european: { fr: 'européen', en: 'European', es: 'europeo', de: 'europäisch', it: 'europeo' },
  'middle-eastern': { fr: 'moyen-oriental', en: 'Middle Eastern', es: 'de Oriente Medio', de: 'nahöstlich', it: 'mediorientale' },
  'latin-american': { fr: 'latino-américain', en: 'Latin American', es: 'latinoamericano', de: 'lateinamerikanisch', it: 'latinoamericano' },
  'north-american': { fr: 'nord-américain', en: 'North American', es: 'norteamericano', de: 'nordamerikanisch', it: 'nordamericano' },
  drinks: { fr: 'boissons', en: 'drinks', es: 'bebidas', de: 'Getränke', it: 'bevande' },
