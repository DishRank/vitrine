...
/**
 * Cockpit stats. Frontière v2 : « analytics = premium ». GRATUIT = le coup
 * d'œil (note ★ + nb d'avis + scans QR ce mois). PREMIUM = le funnel de
 * conversion, les verdicts, le benchmark et la visibilité détaillée.
 *
 * RPC gatées SERVEUR (get_owner_restaurant_stats NULLe les champs détaillés pour
 * un free ; get_owner_benchmark lève PREMIUM_REQUIRED) → on ne rend le détail
 * QUE pour un premium ; un free voit un teaser d'upsell.
 */
