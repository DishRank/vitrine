    ...
    >
      <div className="max-w-[1200px] mx-auto px-4 sm:px-8 flex items-center justify-between h-16">
        ...
        <div className="flex items-center gap-1 sm:gap-2">
          {/* Google Play - Bêta fermée */}
          <button
            onClick={openBetaModal}
            aria-label={`Google Play - ${t('betaClosed')}`}
            className="inline-flex items-center gap-1.5 sm:gap-2 px-2.5 sm:px-3.5 py-1.5 sm:py-2 bg-black text-white rounded-lg hover:bg-gray-800 transition-all border border-gray-700 cursor-pointer"
          >
            <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" className="shrink-0"><path d="M3.609 1.814L13.792 12 3.61 22.186a.996.996 0 0 1-.61-.92V2.734a1 1 0 0 1 .609-.92zm10.89 10.893l2.302 2.302-10.937 6.333 8.635-8.635zm3.199-3.199l2.807 1.626a1 1 0 0 1 0 1.732l-2.807 1.626L15.206 12l2.492-2.492zM5.864 2.658L16.8 8.99l-2.302 2.302-8.634-8.634z"/></svg>
            <div className="text-left leading-none">
              <div className="text-[7px] sm:text-[8px] uppercase tracking-wider opacity-70">{t('betaClosed')}</div>
          ...
          <a
            ...
            className="inline-flex items-center gap-1.5 sm:gap-2 px-2.5 sm:px-3.5 py-1.5 sm:py-2 bg-black text-white rounded-lg hover:bg-gray-800 transition-all border border-gray-700"
          >
