          ...
          <div className="flex flex-col sm:flex-row items-center gap-3 shrink-0">
            {showPlayStore && (
              <a
                ...
                target="_blank"
                rel="noopener"
                onClick={() => trackDownloadClick('play', 'cta_banner')}
                className="store-btn inline-flex items-center gap-2 px-5 py-2.5 text-white font-semibold rounded-lg transition-colors text-sm shrink-0 border"
              >
            ...
            {showAppStore && (
              <a
                ...
                target="_blank"
                rel="noopener"
                onClick={() => trackDownloadClick('apple', 'cta_banner')}
                className="store-btn inline-flex items-center gap-2 px-5 py-2.5 text-white font-semibold rounded-lg transition-colors text-sm shrink-0 border"
              >
